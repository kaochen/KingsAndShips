...
<tileset name="ArcherTower_3" tilewidth="128" tileheight="128" tilecount="1" columns="1">
 <tileoffset x="-14" y="11"/>
  <properties>
  <property name="unit.type" type="str" value="ArcherTower"/>
  <property name="unit.health" type="int" value="100"/>
  <property name="unit.cost" type="int" value="80"/>
  ...
  <property name="weapon.damage" type="int" value="20"/>
  <property name="weapon.firerange" type="int" value="3"/>
  <property name="weapon.firerate" type="int" value="1500"/>
 </properties>
 <image source="original/t_archerTower_03.png" width="128" height="128" zoom="yes"/>
