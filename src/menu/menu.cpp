...
void C_Menu::updateDefenderStatus(){
    ...
    if(m_menuItemsList["playerlife"] == nullptr){
        m_menuItemsList["playerlife"] = new C_GP_Status("playerlife",x - 192,40, GREEN, RED);
    }
...
void C_Menu::updateAttackerStatus(){
        ...
        if(m_menuItemsList["boatLife"] == nullptr){
		    m_menuItemsList["boatLife"] = new C_GP_Status("boatLife",50,40, GREEN,BLUE);
		}
		if(m_menuItemsList["boatLife"] != nullptr){
...
void C_Menu::updateWalletStatus(){
    ...
    if(m_menuItemsList["walletBar"]== nullptr){
		m_menuItemsList["walletBar"] = new C_GP_Status("walletBar",x - 192,100, GREEN, BLUE);
		}
	 if(m_menuItemsList["walletBar"] != nullptr){
